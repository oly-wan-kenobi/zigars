---
name: zigars-runtime-crash-forensics
...
classify it with zigars, and produce the smallest trustworthy reproduction path.
...
3. If debugger or core evidence is needed, preview `zig_debug_plan`,
   ...
   when the zigars tool requires and receives `apply=true`.

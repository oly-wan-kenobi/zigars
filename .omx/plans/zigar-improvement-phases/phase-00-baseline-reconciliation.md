...
- Use Zig 0.16.0.
- Keep zigar deterministic and pure Zig; do not add AI code-generation behavior
  or Python helpers.
- Preserve the workspace sandbox and `apply=true` rule for source-mutating MCP
  tools.
- Keep public tool policy architecture-neutral. Zigar's hexagonal architecture
...
- `packages/zigar-skills-npm/` exists and has moved beyond the placeholder state

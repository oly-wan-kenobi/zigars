...
pub const zig_impact_semantic = tool(.{
    ...
    .handler = handler(.validation_workflows, "zigImpactSemantic"),
...
pub const zig_test_select_semantic = tool(.{
    ...
    .read_only = true,
    .group = .static_analysis,
    .handler = handler(.validation_workflows, "zigTestSelectSemantic"),
...
pub const zigar_validation_plan = tool(.{
    ...
    .handler = handler(.validation_workflows, "zigarValidationPlan"),
...
pub const zigar_validation_run = tool(.{
    ...
    .handler = handler(.validation_workflows, "zigarValidationRun"),
...
pub const zig_build_events = tool(.{
    ...
    .handler = handler(.validation_workflows, "zigBuildEvents"),
...
pub const zig_test_events = tool(.{
    ...
    .group = .agent_workflows,
    .risk = .{ .executes_project_code = true, .executes_backend = true },
    .handler = handler(.validation_workflows, "zigTestEvents"),
    .plan = .{ .dynamic_command = validation_parse },
});
...
pub const zig_test_timing = tool(.{
    ...
    .read_only = true,
    .group = .agent_workflows,
    .handler = handler(.validation_workflows, "zigTestTiming"),
...
pub const zigar_validation_history = tool(.{
    ...
    .read_only = true,
    .group = .agent_workflows,
    .handler = handler(.validation_workflows, "zigarValidationHistory"),
...
pub const zig_test_flake_history = tool(.{
    ...
    .read_only = true,
    .group = .agent_workflows,
    .handler = handler(.validation_workflows, "zigTestFlakeHistory"),
    .plan = .{ .pure_analysis = workflow_state },
});
...
pub const zig_failure_history = tool(.{
    ...
    .read_only = true,
    .group = .agent_workflows,
    .handler = handler(.validation_workflows, "zigFailureHistory"),
    .plan = .{ .pure_analysis = workflow_state },
});
...
pub const zigar_session_snapshot = tool(.{
    ...
    .read_only = true,
    .group = .agent_workflows,
    .handler = handler(.validation_workflows, "zigarSessionSnapshot"),
    .plan = .{ .pure_analysis = workflow_state },
});
...
pub const zigar_handoff_pack = tool(.{
    ...
    .read_only = true,
    .group = .agent_workflows,
    .handler = handler(.validation_workflows, "zigarHandoffPack"),
    .plan = .{ .pure_analysis = workflow_state },
});
...
pub const zigar_decision_record = tool(.{
    ...
    .handler = handler(.validation_workflows, "zigarDecisionRecord"),
...
pub const zigar_project_notes = tool(.{
    ...
    .read_only = true,
    .group = .agent_workflows,
    .handler = handler(.validation_workflows, "zigarProjectNotes"),
    .plan = .{ .pure_analysis = workflow_state },
});
...
pub const zigar_project_memory = tool(.{
    ...
    .read_only = true,
    .group = .agent_workflows,
    .handler = handler(.validation_workflows, "zigarProjectMemory"),
    .plan = .{ .pure_analysis = workflow_state },
});
...
pub const zigar_capability_match = tool(.{
    ...
    .read_only = true,
    .group = .agent_workflows,
    .handler = handler(.validation_workflows, "zigarCapabilityMatch"),
...
pub const zigar_tool_sequence_plan = tool(.{
    ...
    .read_only = true,
    .group = .agent_workflows,
    .handler = handler(.validation_workflows, "zigarToolSequencePlan"),

...
pub const zig_ci_ingest = tool(.{
    ...
    .read_only = true,
    .group = .ci_artifacts,
    .handler = handler(.phase6, "zigCiIngest"),
...
pub const zig_ci_repro_plan = tool(.{
    ...
    .read_only = true,
    .group = .ci_artifacts,
    .handler = handler(.phase6, "zigCiReproPlan"),
    .plan = .{ .pure_analysis = ci_ingest_plan },
});
...
pub const zig_ci_failure_map = tool(.{
    ...
    .read_only = true,
    .group = .ci_artifacts,
    .handler = handler(.phase6, "zigCiFailureMap"),
    .plan = .{ .pure_analysis = ci_ingest_plan },
});
...
pub const zig_release_plan = tool(.{
    ...
    .handler = handler(.phase6, "zigReleasePlan"),
...
pub const zig_semver_suggest = tool(.{
    ...
    .read_only = true,
    .group = .release_intelligence,
    .handler = handler(.phase6, "zigSemverSuggest"),
    .plan = .{ .pure_analysis = release_plan },
});
...
pub const zig_release_notes_draft = tool(.{
    ...
    .read_only = true,
    .group = .release_intelligence,
    .handler = handler(.phase6, "zigReleaseNotesDraft"),
    .plan = .{ .pure_analysis = release_plan },
});
...
pub const zig_release_evidence_pack = tool(.{
    ...
    .read_only = true,
    .group = .release_intelligence,
    .handler = handler(.phase6, "zigReleaseEvidencePack"),
    .plan = .{ .pure_analysis = release_plan },
});
...
pub const zig_api_baseline_init = tool(.{
    ...
    .handler = handler(.phase6, "zigApiBaselineInit"),
...
pub const zig_api_check = tool(.{
    ...
    .read_only = true,
    .group = .api_lifecycle,
    .handler = handler(.phase6, "zigApiCheck"),
...
pub const zig_api_diff_baseline = tool(.{
    ...
    .read_only = true,
    .group = .api_lifecycle,
    .handler = handler(.phase6, "zigApiDiffBaseline"),
    .plan = .{ .pure_analysis = api_plan },
});
...
pub const zig_api_docs_diff = tool(.{
    ...
    .read_only = true,
    .group = .api_lifecycle,
    .handler = handler(.phase6, "zigApiDocsDiff"),
    .plan = .{ .pure_analysis = api_plan },
});
...
pub const zig_docs_index_build = tool(.{
    ...
    .read_only = true,
    .group = .docs,
    .handler = handler(.phase6, "zigDocsIndexBuild"),
...
pub const zig_docs_query = tool(.{
    ...
    .read_only = true,
    .group = .docs,
    .handler = handler(.phase6, "zigDocsQuery"),
    .plan = .{ .pure_analysis = docs_plan },
});
...
pub const zig_std_signature = tool(.{
    ...
    .read_only = true,
    .group = .docs,
    .handler = handler(.phase6, "zigStdSignature"),
    .plan = .{ .pure_analysis = docs_plan },
});
...
pub const zig_langref_item = tool(.{
    ...
    .read_only = true,
    .group = .docs,
    .handler = handler(.phase6, "zigLangrefItem"),
    .plan = .{ .pure_analysis = docs_plan },
});
...
pub const zig_autodoc_ingest = tool(.{
    ...
    .read_only = true,
    .group = .docs,
    .handler = handler(.phase6, "zigAutodocIngest"),
    .plan = .{ .pure_analysis = docs_plan },
});
...
pub const zig_project_docs_query = tool(.{
    ...
    .read_only = true,
    .group = .docs,
    .handler = handler(.phase6, "zigProjectDocsQuery"),
    .plan = .{ .pure_analysis = docs_plan },
});
...
pub const zig_doc_example_check = tool(.{
    ...
    .read_only = true,
    .group = .docs,
    .handler = handler(.phase6, "zigDocExampleCheck"),
    .plan = .{ .pure_analysis = docs_plan },
});
...
pub const zig_snippet_check = tool(.{
    ...
    .read_only = true,
    .group = .docs,
    .handler = handler(.phase6, "zigSnippetCheck"),
    .plan = .{ .pure_analysis = docs_plan },
});
...
pub const zig_readme_command_check = tool(.{
    ...
    .read_only = true,
    .group = .docs,
    .handler = handler(.phase6, "zigReadmeCommandCheck"),
    .plan = .{ .pure_analysis = docs_plan },
});
...
pub const zig_dependency_update_plan = tool(.{
    ...
    .handler = handler(.phase6, "zigDependencyUpdatePlan"),
...
pub const zig_dependency_fetch_check = tool(.{
    ...
    .read_only = true,
    .group = .dependency_security,
    .handler = handler(.phase6, "zigDependencyFetchCheck"),
    .plan = .{ .pure_analysis = dependency_plan },
});
...
pub const zig_dependency_lock_audit = tool(.{
    ...
    .read_only = true,
    .group = .dependency_security,
    .handler = handler(.phase6, "zigDependencyLockAudit"),
    .plan = .{ .pure_analysis = dependency_plan },
});
...
pub const zig_dependency_impact = tool(.{
    ...
    .read_only = true,
    .group = .dependency_security,
    .handler = handler(.phase6, "zigDependencyImpact"),
    .plan = .{ .pure_analysis = dependency_plan },
});
...
pub const zig_sbom = tool(.{
    ...
    .group = .dependency_security,
    .risk = .{ .writes_artifacts = true, .writes_require_apply = true, .preview_by_default = true },
    .handler = handler(.phase6, "zigSbom"),
...
pub const zig_zat_scan = tool(.{
    ...
    .read_only = true,
    .group = .dependency_security,
    .handler = handler(.phase6, "zigZatScan"),
...
pub const zig_osv_scan = tool(.{
    ...
    .read_only = true,
    .group = .dependency_security,
    .handler = handler(.phase6, "zigOsvScan"),
    .plan = .{ .pure_analysis = optional_security_plan },
});
...
pub const zig_dependency_security_report = tool(.{
    ...
    .read_only = true,
    .group = .dependency_security,
    .handler = handler(.phase6, "zigDependencySecurityReport"),
    .plan = .{ .pure_analysis = dependency_plan },
});
...
pub const zig_dependency_provenance = tool(.{
    ...
    .read_only = true,
    .group = .dependency_security,
    .handler = handler(.phase6, "zigDependencyProvenance"),
    .plan = .{ .pure_analysis = dependency_plan },
});
...
pub const zig_dependency_license_summary = tool(.{
    ...
    .read_only = true,
    .group = .dependency_security,
    .handler = handler(.phase6, "zigDependencyLicenseSummary"),
    .plan = .{ .pure_analysis = dependency_plan },
});
...
pub const zig_github_dependency_submit_plan = tool(.{
    ...
    .read_only = true,
    .group = .dependency_security,
    .handler = handler(.phase6, "zigGithubDependencySubmitPlan"),
    .plan = .{ .pure_analysis = dependency_plan },
});

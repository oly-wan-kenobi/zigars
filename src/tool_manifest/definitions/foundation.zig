...
pub const zigar_artifact_index = tool(.{
    ...
    .handler = handler(.artifacts, "zigarArtifactIndex"),
...
pub const zigar_artifact_read = tool(.{
    ...
    .read_only = true,
    .group = .artifact_registry,
    .handler = handler(.artifacts, "zigarArtifactRead"),
...
pub const zigar_artifact_prune = tool(.{
    ...
    .handler = handler(.artifacts, "zigarArtifactPrune"),
...
pub const zigar_metrics_v2 = tool(.{
    ...
    .read_only = true,
    .group = .observability,
    .handler = handler(.observability, "zigarMetricsV2"),
...
pub const zigar_backend_health_history = tool(.{
    ...
    .read_only = true,
    .group = .observability,
    .handler = handler(.observability, "zigarBackendHealthHistory"),
...
pub const zigar_zls_timeline = tool(.{
    ...
    .read_only = true,
    .group = .observability,
    .handler = handler(.observability, "zigarZlsTimeline"),
...
pub const zigar_tool_latency = tool(.{
    ...
    .read_only = true,
    .group = .observability,
    .handler = handler(.observability, "zigarToolLatency"),
...
pub const zigar_trust_report = tool(.{
    ...
    .handler = handler(.trust, "zigarTrustReport"),
...
pub const zigar_command_provenance = tool(.{
    ...
    .read_only = true,
    .group = .trust_safety,
    .handler = handler(.trust, "zigarCommandProvenance"),
...
pub const zigar_risk_audit = tool(.{
    ...
    .read_only = true,
    .group = .trust_safety,
    .handler = handler(.trust, "zigarRiskAudit"),
...
pub const zigar_clean_tree_gate = tool(.{
    ...
    .group = .trust_safety,
    .risk = .{ .executes_backend = true },
    .handler = handler(.trust, "zigarCleanTreeGate"),
...
pub const zigar_result_shape = tool(.{
    ...
    .handler = handler(.result_shape, "zigarResultShape"),
...
pub const zigar_output_budget_plan = tool(.{
    ...
    .read_only = true,
    .group = .result_contracts,
    .handler = handler(.result_shape, "zigarOutputBudgetPlan"),
...
pub const zigar_docs_drift_check = tool(.{
    ...
    .read_only = true,
    .group = .release_drift,
    .handler = handler(.release_drift, "zigarDocsDriftCheck"),
...
pub const zigar_release_claim_check = tool(.{
    ...
    .read_only = true,
    .group = .release_drift,
    .handler = handler(.release_drift, "zigarReleaseClaimCheck"),
...
pub const zigar_tool_index_check = tool(.{
    ...
    .read_only = true,
    .group = .release_drift,
    .handler = handler(.release_drift, "zigarToolIndexCheck"),

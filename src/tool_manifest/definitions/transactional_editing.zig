...
pub const zigar_patch_session_create = tool(.{
    ...
    .handler = handler(.transactional_editing, "zigarPatchSessionCreate"),
...
pub const zigar_patch_session_preview = tool(.{
    ...
    .handler = handler(.transactional_editing, "zigarPatchSessionPreview"),
...
pub const zigar_patch_session_apply = tool(.{
    ...
    .handler = handler(.transactional_editing, "zigarPatchSessionApply"),
...
pub const zigar_patch_session_validate = tool(.{
    ...
    .handler = handler(.transactional_editing, "zigarPatchSessionValidate"),
...
pub const zigar_patch_session_revert = tool(.{
    ...
    .handler = handler(.transactional_editing, "zigarPatchSessionRevert"),
...
pub const zig_generated_file_trace = tool(.{
    ...
    .read_only = true,
    .group = .trust_safety,
    .handler = handler(.transactional_editing, "zigGeneratedFileTrace"),
...
pub const zigar_edit_policy_check = tool(.{
    ...
    .read_only = true,
    .group = .trust_safety,
    .handler = handler(.transactional_editing, "zigarEditPolicyCheck"),
    .plan = .{ .pure_analysis = generated_policy },
});
...
pub const zigar_generated_route = tool(.{
    ...
    .read_only = true,
    .group = .trust_safety,
    .handler = handler(.transactional_editing, "zigarGeneratedRoute"),
    .plan = .{ .pure_analysis = generated_policy },
});
...
pub const zig_move_decl = tool(.{
    ...
    .group = .formatting_and_edits,
    .risk = .{ .writes_source = true, .writes_require_apply = true, .preview_by_default = true },
    .handler = handler(.transactional_editing, "zigMoveDecl"),
...
pub const zig_extract_decl = tool(.{
    ...
    .group = .formatting_and_edits,
    .risk = .{ .writes_source = true, .writes_require_apply = true, .preview_by_default = true },
    .handler = handler(.transactional_editing, "zigExtractDecl"),
    .plan = .{ .apply_gated_mutation = refactor_preview },
});
...
pub const zig_update_imports = tool(.{
    ...
    .group = .formatting_and_edits,
    .risk = .{ .writes_source = true, .writes_require_apply = true, .preview_by_default = true },
    .handler = handler(.transactional_editing, "zigUpdateImports"),
    .plan = .{ .apply_gated_mutation = refactor_preview },
});
...
pub const zig_organize_imports = tool(.{
    ...
    .group = .formatting_and_edits,
    .risk = .{ .writes_source = true, .writes_require_apply = true, .preview_by_default = true },
    .handler = handler(.transactional_editing, "zigOrganizeImports"),
    .plan = .{ .apply_gated_mutation = refactor_preview },
});
...
pub const zig_code_action_batch = tool(.{
    ...
    .handler = handler(.transactional_editing, "zigCodeActionBatch"),

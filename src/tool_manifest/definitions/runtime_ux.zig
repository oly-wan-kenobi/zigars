...
pub const zigar_job_start = tool(.{
    ...
    .handler = handler(.runtime_ux, "zigarJobStart"),
...
pub const zigar_job_status = tool(.{
    ...
    .read_only = true,
    .group = .runtime_ux,
    .handler = handler(.runtime_ux, "zigarJobStatus"),
...
pub const zigar_job_result = tool(.{
    ...
    .read_only = true,
    .group = .runtime_ux,
    .handler = handler(.runtime_ux, "zigarJobResult"),
...
pub const zigar_job_cancel = tool(.{
    ...
    .read_only = false,
    .group = .runtime_ux,
    .handler = handler(.runtime_ux, "zigarJobCancel"),
...
pub const zigar_cancel_status = tool(.{
    ...
    .read_only = true,
    .group = .runtime_ux,
    .handler = handler(.runtime_ux, "zigarCancelStatus"),
...
pub const zigar_run_stream = tool(.{
    ...
    .group = .runtime_ux,
    .risk = .{ .executes_project_code = true, .executes_backend = true },
    .handler = handler(.runtime_ux, "zigarRunStream"),
...
pub const zigar_run_events = tool(.{
    ...
    .read_only = true,
    .group = .runtime_ux,
    .handler = handler(.runtime_ux, "zigarRunEvents"),
...
pub const zigar_resource_query = tool(.{
    ...
    .read_only = true,
    .group = .runtime_ux,
    .handler = handler(.runtime_ux, "zigarResourceQuery"),
...
pub const zigar_resource_subscribe = tool(.{
    ...
    .read_only = false,
    .group = .runtime_ux,
    .handler = handler(.runtime_ux, "zigarResourceSubscribe"),
...
pub const zigar_resource_unsubscribe = tool(.{
    ...
    .read_only = false,
    .group = .runtime_ux,
    .handler = handler(.runtime_ux, "zigarResourceUnsubscribe"),
    .plan = .{ .not_plannable = "Mutates process-local subscription state only." },
});
...
pub const zigar_roots_sync = tool(.{
    ...
    .handler = handler(.runtime_ux, "zigarRootsSync"),
...
pub const zigar_workspace_map = tool(.{
    ...
    .read_only = true,
    .group = .runtime_ux,
    .handler = handler(.runtime_ux, "zigarWorkspaceMap"),
...
pub const zigar_workspace_select = tool(.{
    ...
    .group = .runtime_ux,
    .risk = .{ .writes_require_apply = true, .preview_by_default = true },
    .handler = handler(.runtime_ux, "zigarWorkspaceSelect"),
...
pub const zigar_agent_guide_v2 = tool(.{
    ...
    .read_only = true,
    .group = .runtime_ux,
    .handler = handler(.runtime_ux, "zigarAgentGuideV2"),
...
pub const zigar_client_guide = tool(.{
    ...
    .read_only = true,
    .group = .runtime_ux,
    .handler = handler(.runtime_ux, "zigarClientGuide"),
...
pub const zigar_prompt_pack = tool(.{
    ...
    .read_only = true,
    .group = .runtime_ux,
    .handler = handler(.runtime_ux, "zigarPromptPack"),

...
pub const group_specs = [_]GroupSpec{
    ...
    .{ .group = .dependency_security, .keywords = &.{ "dependency update", "dependency fetch", "lock audit", "sbom", "cyclonedx", "security scan", "osv", "zat", "license", "dependency submission", "provenance", "build.zig.zon mutation", "zig fetch hash", "dependency add", "dependency remove", "dependency upgrade", "dependency migration", "package search", "zigistry", "direct url", "registry provider" } },

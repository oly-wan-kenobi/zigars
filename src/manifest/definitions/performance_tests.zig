...
const zig_coverage_map = subject.zig_coverage_map;
const zig_coverage_merge = subject.zig_coverage_merge;
const zig_coverage_diff = subject.zig_coverage_diff;
const zig_coverage_baseline = subject.zig_coverage_baseline;
const zig_coverage_budget_check = subject.zig_coverage_budget_check;

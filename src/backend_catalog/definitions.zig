...
pub const backends = [_]Backend{
    ...
    .{
        ...
        .install_strategy = "Pin a zflame executable in the project toolchain, dev shell, or CI image; keep capture tooling and capture semantics separate from zigar rendering.",

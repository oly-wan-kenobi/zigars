...
const migrated_phase6 = struct {
    ...
    pub const zigZonDepSync = mcp_tools.dependencies.zigZonDepSync;
    pub const zigDepsAdd = mcp_tools.dependencies.zigDepsAdd;
    pub const zigDepsRemove = mcp_tools.dependencies.zigDepsRemove;
    pub const zigDepsUpgrade = mcp_tools.dependencies.zigDepsUpgrade;
    pub const zigPkgSearch = mcp_tools.dependencies.zigPkgSearch;
    pub const zigPkgInfo = mcp_tools.dependencies.zigPkgInfo;
    pub const zigPkgVersions = mcp_tools.dependencies.zigPkgVersions;
    pub const zigPkgReadme = mcp_tools.dependencies.zigPkgReadme;
    pub const zigDependencyMigrate = mcp_tools.dependencies.zigDependencyMigrate;
};
...
const migrated_static_analysis = struct {
    ...
    pub const zigTestNameResolve = mcp_tools.static_analysis.zigTestNameResolve;
    pub const zigTestFixtureInventory = mcp_tools.static_analysis.zigTestFixtureInventory;
    pub const zigSafetySiteCatalog = mcp_tools.static_analysis.zigSafetySiteCatalog;
    pub const zigTestForSymbol = mcp_tools.static_analysis.zigTestForSymbol;
    pub const zigModuleSurface = mcp_tools.static_analysis.zigModuleSurface;
    pub const zigSymbolDossier = mcp_tools.static_analysis.zigSymbolDossier;
    pub const zigChangeRiskAudit = mcp_tools.static_analysis.zigChangeRiskAudit;
    pub const zigInsertionSites = mcp_tools.static_analysis.zigInsertionSites;
    pub const zigIoMigrationScan = mcp_tools.static_analysis.zigIoMigrationScan;
    pub const zigLeakTriage = mcp_tools.static_analysis.zigLeakTriage;
    pub const zigComptimeDiagnose = mcp_tools.static_analysis.zigComptimeDiagnose;
    pub const zigMemoryLayout = mcp_tools.static_analysis.zigMemoryLayout;
    pub const zigUnsafeOperationsAudit = mcp_tools.static_analysis.zigUnsafeOperationsAudit;
    pub const zigAbiLayoutDiff = mcp_tools.static_analysis.zigAbiLayoutDiff;

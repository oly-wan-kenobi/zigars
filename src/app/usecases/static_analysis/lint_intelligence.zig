...
// Implementation helpers extracted to lint_intelligence_support.zig.
const lint_support = @import("lint_intelligence_support.zig");
pub const LintError = lint_support.LintError;
const argvContains = lint_support.argvContains;
const argvValue = lint_support.argvValue;
const backendErrorKind = lint_support.backendErrorKind;
const backendErrorValue = lint_support.backendErrorValue;
const collectCompilerLines = lint_support.collectCompilerLines;
const commandErrorSummaryValue = lint_support.commandErrorSummaryValue;
const commandErrorValue = lint_support.commandErrorValue;
const commandResultValue = lint_support.commandResultValue;
const commandString = lint_support.commandString;
const commandTermValue = lint_support.commandTermValue;
const commandTimeout = lint_support.commandTimeout;
const comparisonKey = lint_support.comparisonKey;
const compilerInsightsValue = lint_support.compilerInsightsValue;
const compilerLineValue = lint_support.compilerLineValue;
const compilerNextActions = lint_support.compilerNextActions;
const compilerNextCommand = lint_support.compilerNextCommand;
const failureSummaryValue = lint_support.failureSummaryValue;
const findByComparisonKey = lint_support.findByComparisonKey;
const findingValue = lint_support.findingValue;
const fingerprintValue = lint_support.fingerprintValue;
const graphCommandFailedValue = lint_support.graphCommandFailedValue;
const graphOutputBaseErrorValue = lint_support.graphOutputBaseErrorValue;
const graphOutputInspectErrorValue = lint_support.graphOutputInspectErrorValue;
const graphOutputMissingValue = lint_support.graphOutputMissingValue;
const integerField = lint_support.integerField;
const likelyFailureScopeValue = lint_support.likelyFailureScopeValue;
const locationValue = lint_support.locationValue;
const ownedString = lint_support.ownedString;
const putStreamFields = lint_support.putStreamFields;
const requireCommandRunner = lint_support.requireCommandRunner;
const safeTextAlloc = lint_support.safeTextAlloc;
const serializeAlloc = lint_support.serializeAlloc;
const serializeString = lint_support.serializeString;
const serializeValue = lint_support.serializeValue;
const severityOf = lint_support.severityOf;
const stringArrayValue = lint_support.stringArrayValue;
const stringField = lint_support.stringField;
const summaryValue = lint_support.summaryValue;

pub const command_output_limit = lint_support.command_output_limit;
pub const command_output_limit_mode = lint_support.command_output_limit_mode;

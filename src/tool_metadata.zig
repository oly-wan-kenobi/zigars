...
pub const ZlsPlan = tool_manifest.ZlsPlan;
pub const PlanPolicy = tool_manifest.PlanPolicy;
...
pub const planFor = tool_manifest.planFor;
pub const commandPlanFor = tool_manifest.commandPlanFor;
pub const planKind = tool_manifest.planKind;

...
pub const backends = [_]Backend{
    ...
    .{
        ...
        .install_strategy = "Pin a zwanzig executable in the project toolchain, dev shell, or CI image; for zigar release validation, use tools/release/real_backend_pins.json and .github/scripts/setup-real-backends.sh.",
    ...
    .{
        ...
        .install_strategy = "Pin a diff-folded executable beside zflame when differential flamegraphs are part of the project workflow; the zigar release-validation pin is documented in tools/release/real_backend_pins.json.",

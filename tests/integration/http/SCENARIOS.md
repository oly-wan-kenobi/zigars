...
- `tools/integration/http/http_smoke.zig`
- `tools/integration/http/http_validation_workflow_smoke.zig`
- `tools/integration/http/http_transactional_editing_smoke.zig`
- `tools/integration/http/http_phase6_smoke.zig`
- `tools/integration/http/http_performance_smoke.zig`
- `tools/integration/http/http_diagnostics_smoke.zig`
- `tools/integration/http/http_adoption_smoke.zig`
- `tools/integration/http/http_runtime_ux_smoke.zig`
...
- `tools/coverage/coverage_config.zig` requires at least 154 HTTP smoke scenarios.
